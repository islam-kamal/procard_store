...
/*
class DiscountModel extends BaseMappable{
  List<Data> data;

  DiscountModel({this.data});
  ...
  Mappable fromJson(Map<String, dynamic> json) {
    ...
    return DiscountModel(data: data);
  }
}
...
class Data {
  ...
  Data({this.id, this.price, this.currency, this.card});
...
class DiscountModel extends BaseMappable{
  ...
  DiscountModel({this.status, this.data});
  ...
  Mappable fromJson(Map<String, dynamic> json) {
    ...
    return DiscountModel(status: status,data: data);
  }
}
