...
class LatestCardsModel extends BaseMappable{
  int status;
  List<Data> data;

  LatestCardsModel({this.status, this.data});

  LatestCardsModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    if (json['data'] != null) {
      data = new List<Data>();
      json['data'].forEach((v) {
  ...
  Mappable fromJson(Map<String, dynamic> json) {
    ...
    return LatestCardsModel(status: status,data: data);
  }
}
